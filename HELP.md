...
* The original package name 'com.spring.native-poc' is invalid and this project uses 'com.spring.nativepoc' instead.
...
```
$ docker run --rm -p 8080:8080 native-poc:0.0.1-SNAPSHOT
```
